...
def home():
    ...
    app.logger.info("Test info that should NOT show in the stream")
...
def authorized():
    ...
    if request.args.get('code'):
        ...
        if "error" in result:
            app.logger.warning("Oh noooo something went wrong! (In prod this should be more meaningful)")
        ...
        login_user(user)
        _save_cache(cache)
        app.logger.warning(f"{user} is in the house!!")
    return redirect(url_for('home'))
